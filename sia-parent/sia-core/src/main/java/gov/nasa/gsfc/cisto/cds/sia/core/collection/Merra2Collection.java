...
/**
 * The type Merra 2 collection.
 */
@XmlAccessorType(XmlAccessType.FIELD)
public class Merra2Collection implements SiaCollection {

    private static final String xmlCollectionSetupFile = "/merra2_mapreduce_collections.xml";
    ...
    /**
     * Instantiates a new Merra 2 collection.
     */
    public Merra2Collection() {
    }
