...
public class HadoopConfiguration {
  ...
  public HadoopConfiguration(String[] args) throws ConfigurationException {
    ...
    // TODO: change the function parameter of gov.nasa.gsfc.cisto.cds.sia.core.config.SiaConfiguration.buildSpatiotemporalFilters
      // Actually, the input parameters here did not make any sense
    SpatiotemporalFilters spatiotemporalFilters = mapreducerConfiguration.buildSpatiotemporalFilters(null);
