 ...
 *
 */
public class AavgCombiner extends Reducer<Text, AreaAvgWritable, Text, AreaAvgWritable> {
	 ...
	 */
	public void reduce(Text key, Iterable<AreaAvgWritable> value, Reducer<Text, AreaAvgWritable, Text, AreaAvgWritable>.Context context)
